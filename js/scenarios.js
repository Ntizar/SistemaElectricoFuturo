...
(function() {
    ...
    SEF.ESCENARIOS = [
        ...
        // ======================================================================
        //  ESCENARIOS CETERIS PARIBUS — POLÍTICA NUCLEAR
        //  Comparativa donde TODO permanece igual excepto la política nuclear.
        //  MISMOS parámetros de renovables, almacenamiento, demanda, precios,
        //  electrificación y eficiencia. La ÚNICA variable que cambia es nuclear.
        // ======================================================================
        escenario(
            18,
            'Cierre ENRESA oficial',
            '⚛️',
            'Cierre nuclear según calendario oficial ENRESA sin prórroga. Usa el plan de cierre programado (aplicarPlanNuclear=true, prorrogaNuclear=false). Año horizonte 2035 con el resto de parámetros fijos idénticos a los escenarios de prórroga nuclear para aislar el efecto del cierre.',
            {
                anioObjetivo: 2035,
                aplicarPlanNuclear: true,
                prorrogaNuclear: false,
        ...
        escenario(
            19,
            'Prórroga nuclear 10 años',
            '🛡️',
            'Prórroga de 10 años del parque nuclear (prorrogaNuclear=true, prorrogaGlobal=10). Todos los demás parámetros — renovables, almacenamiento, demanda, precios — son idénticos al escenario Cierre ENRESA oficial para aislar exclusivamente el efecto de mantener la generación nuclear una década adicional.',
            {
                anioObjetivo: 2035,
                aplicarPlanNuclear: true,
                prorrogaNuclear: true,
        ...
        escenario(
            20,
            'Prórroga nuclear 20 años (60 años vida)',
            '🧱',
            'Prórroga de 20 años del parque nuclear (prorrogaNuclear=true, prorrogaGlobal=20), equivalente a extender la vida útil de las centrales hasta los 60 años. Todos los demás parámetros son idénticos al escenario Cierre ENRESA oficial para aislar exclusivamente el efecto del mantenimiento nuclear a largo plazo.',
            {
                anioObjetivo: 2035,
                aplicarPlanNuclear: true,
                prorrogaNuclear: true,
        ...
        escenario(
            21,
            'Cierre nuclear acelerado 2030',
            '🚀',
            'Cierre acelerado de TODO el parque nuclear en 2030 (aplicarPlanNuclear=true, cierreNuclear=2030). Todos los demás parámetros son idénticos al escenario Cierre ENRESA oficial, aislando exclusivamente el efecto de adelantar el cierre nuclear a 2030 frente a las alternativas de prórroga.',
            {
                anioObjetivo: 2035,
                aplicarPlanNuclear: true,
                cierreNuclear: 2030,
